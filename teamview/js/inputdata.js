...
global.org.apps = {
  crm : {
    ...
    description : "For managing prospects and existing customers",
  ...
  accounting : {
    name : "accounting",
    label : "Accounting",
    description : "For managing invoices, quotes, cashflow and taxes",
  ...
  humanresources : {
    ...
    description : "For managing employees, time off requests, job applications, onboarding, and more",
